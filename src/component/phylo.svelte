    ...
    function rerender(tree_str) {
        ...
        treeref.querySelectorAll('.node-circle').forEach((elem) => {
            elem.addEventListener('mouseover', (e) => {
                console.log(e)
                console.log(document.querySelector('#tree_container'))
